...
//  Core
//
//  Created by Chandrala on 1/7/25.
...
extension DTO {
  public typealias GetFollowingRecordListResponse = [GetFollowingRecordListContent]
}

public struct GetFollowingRecordListContent: BaseResponse {
  public let id: Int
  public let fileUrl: FileUrl
  public let content: String
  public let exhibitionName: String
